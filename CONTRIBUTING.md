# Contributing to Retail Sales Forecasting
...
2. **Clone** your fork: `git clone https://github.com/<your-username>/retail-sales-forecasting.git`
...
Multi-model forecasting pipeline including Facebook Prophet.
